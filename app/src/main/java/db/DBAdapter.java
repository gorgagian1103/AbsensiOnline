...
public class DBAdapter extends SQLiteOpenHelper {
    ...
    // Contacts table name
    private static final String LECTURER_INFO_TABLE = "lecturer_table";
    ...
    private static final String KEY_LECTURER_FIRSTNAME = "lecturer_firstname";
    private static final String KEY_LECTURER_LASTNAME = "lecturer_Lastname";
    private static final String KEY_LECTURER_MO_NO = "lecturer_mobilenumber";
    private static final String KEY_LECTURER_ADDRESS = "lecturer_address";
    private static final String KEY_LECTURER_USERNAME = "lecturer_username";
    private static final String KEY_LECTURER_PASSWORD = "lecturer_password";
    ...
    public void onCreate(SQLiteDatabase db) {
        String queryLecturer = "CREATE TABLE " + LECTURER_INFO_TABLE + " (" +
                KEY_LECTURER_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                KEY_LECTURER_FIRSTNAME + " TEXT, " +
                KEY_LECTURER_LASTNAME + " TEXT, " +
                KEY_LECTURER_MO_NO + " TEXT, " +
                KEY_LECTURER_ADDRESS + " TEXT," +
                KEY_LECTURER_USERNAME + " TEXT," +
                KEY_LECTURER_PASSWORD + " TEXT " + ")";
        Log.d("queryLecturer", queryLecturer);
    ...
    public void onUpgrade(SQLiteDatabase db, int arg1, int arg2) {
        String queryLecturer = "CREATE TABLE " + LECTURER_INFO_TABLE + " (" +
                ...
                KEY_LECTURER_USERNAME + " TEXT," +
                KEY_LECTURER_PASSWORD + " TEXT " + ")";
        Log.d("queryFaculty", queryLecturer);
    ...
    public void addLecturer(LecturerBean lecturerBean) {
        ...
        String query = "INSERT INTO lecturer_table (lecturer_firstname,lecturer_Lastname,lecturer_mobilenumber,lecturer_address,lecturer_username,lecturer_password) values ('" +
                lecturerBean.getLecturer_firstname() + "', '" +
                lecturerBean.getLecturer_lastname() + "', '" +
                lecturerBean.getLecturer_mobilenumber() + "', '" +
                lecturerBean.getLecturer_address() + "', '" +
                lecturerBean.getLecturer_username() + "', '" +
                lecturerBean.getLecturer_password() + "')";
        Log.d("query", query);
        db.execSQL(query);
        db.close();
    }

    public LecturerBean validateLecturer(String userName, String password) {
        SQLiteDatabase db = this.getWritableDatabase();

        String query = "SELECT * FROM lecturer_table where lecturer_username='" + userName + "' and lecturer_password='" + password + "'";
        Cursor cursor = db.rawQuery(query, null);

        if (cursor.moveToFirst()) {
            LecturerBean lecturerBean = new LecturerBean();
            lecturerBean.setLecturer_id(Integer.parseInt(cursor.getString(0)));
            lecturerBean.setLecturer_firstname(cursor.getString(1));
            lecturerBean.setLecturer_lastname(cursor.getString(2));
            lecturerBean.setLecturer_mobilenumber(cursor.getString(3));
            lecturerBean.setLecturer_address(cursor.getString(4));
            lecturerBean.setLecturer_username(cursor.getString(5));
            lecturerBean.setLecturer_password(cursor.getString(6));
            return lecturerBean;
        }
        return null;
    }

    public ArrayList<LecturerBean> getAllLecturer() {
        Log.d("in get all", "in get all");
        ArrayList<LecturerBean> list = new ArrayList<LecturerBean>();
    ...
    public void deleteLecturer(int lecturerId) {
        ...
        String query = "DELETE FROM lecturer_table WHERE lecturer_id=" + lecturerId;
    ...
    public int addAttendanceSession(AttendanceSessionBean attendanceSessionBean) {
        ...
        String query = "INSERT INTO attendance_session_table (attendance_session_lecturer_id,attendance_session_department,attendance_session_class,attendance_session_date,attendance_session_subject) values ('" +
                attendanceSessionBean.getAttendance_session_lecturer_id() + "', '" +
    ...
    public ArrayList<AttendanceSessionBean> getAllAttendanceSession() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                attendanceSessionBean.setAttendance_session_lecturer_id(Integer.parseInt(cursor.getString(1)));
    ...
    public ArrayList<AttendanceBean> getAttendanceBySessionID(AttendanceSessionBean attendanceSessionBean) {
        ...
        SQLiteDatabase db = this.getWritableDatabase();
        String query = "SELECT * FROM attendance_session_table where attendance_session_faculty_id=" + attendanceSessionBean.getAttendance_session_lecturer_id() + ""
