...
public class AttendanceSessionBean {
    ...
    private int attendance_session_lecturer_id;
    ...
    public int getAttendance_session_lecturer_id() {
        return attendance_session_lecturer_id;
    }
    public void setAttendance_session_lecturer_id(int attendance_session_lecturer_id) {
        this.attendance_session_lecturer_id = attendance_session_lecturer_id;
    }
